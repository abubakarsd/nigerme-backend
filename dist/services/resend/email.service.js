    ...
    static async sendMemberInvitationEmail(personalEmail, name, organizationName, assignedOrgEmail, tempPassword) {
      ...
      <body>
        <div class="container">
          ...
          <div style="margin-top: 24px; width: 100%; border-radius: 8px; overflow: hidden;">
            <img src="${exports.FOOTER_BANNER_URL}" alt="Nigerme" width="100%" style="width: 100%; max-width: 100%; height: auto; display: block; border-radius: 8px; border: 0;" />
          </div>
      ...
      <body>
        <div class="container">
          ...
          <div style="margin-top: 24px; width: 100%; border-radius: 0;">
            <img src="${exports.FOOTER_BANNER_URL}" alt="Nigerme" width="100%" style="width: 100%; max-width: 100%; height: auto; display: block; border-radius: 0; border: 0;" />
          </div>
